...
from vars_interface.vars_type.extra import read_home_var_extra, check_extra_variable
from vars_interface.vars_type.perso import read_home_var_perso, check_perso_variable
