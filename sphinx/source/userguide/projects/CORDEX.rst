...
.. glossary::
   ...
   CORDEX_domain
      ...
      default values:
         ...
         - simulation['CORDEX_domain'][internal['context']]
   ...
   Lambert_conformal_longitude_of_central_meridian
      ...
      default values:
         ...
         - simulation['Lambert_conformal_longitude_of_central_meridian']
   ...
   Lambert_conformal_standard_parallel
      ...
      default values:
         ...
         - simulation['Lambert_conformal_standard_parallel']
   ...
   driving_experiment_name
      ...
      default values:
         ...
         - simulation['driving_experiment_name']
