      ...
      Variables
         ...
         driving_model_id
            ...
            values:
               ...
               - attrs[driving_model_id]
               - common[driving_model_id]
         ...
         driving_model_ensemble_member
            ...
            values:
               ...
               - attrs[driving_model_ensemble_member]
               - common[driving_model_ensemble_member]
         ...
         driving_experiment_name
            ...
            values:
               ...
               - attrs[driving_experiment_name]
               - common[driving_experiment_name]
         ...
         title
            ...
            values:
               ...
               - function from self named format('source'= internal[source_id], 'project'= 'CMIP6', 'activity'= common[activity_id], 'expid'= simulation[expid_in_filename])
               - function from self named format('source'= internal[source_id], 'project'= 'CMIP6', 'activity'= common[activity_id], 'expid'= internal[experiment_id])
