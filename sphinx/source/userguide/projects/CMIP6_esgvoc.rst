...
.. glossary::
   ...
   CV_experiment
      ...
      values:
         ...
         - function from vocabulary named get_term_in_collection('project_id'= init[vocabulary_project], 'collection_id'= 'experiment_id', 'term_id'= internal[experiment_id])
...
.. glossary::
   ...
   institution_input
      ...
      values:
         ...
         - function from vocabulary named get_term_in_collection('project_id'= init[vocabulary_project], 'collection_id'= 'institution_id', 'term_id'= init[institution_id] formatted with function from self named lower({}))
   ...
   parent_experiment_id
      ...
      values:
         ...
         - internal[CV_experiment][parent_experiment]
   ...
   source_input
      ...
      values:
         ...
         - function from vocabulary named get_term_in_collection('project_id'= init[vocabulary_project], 'collection_id'= 'source_id', 'term_id'= internal[source_id] formatted with function from self named lower({}))
      ...
      Variables
         ...
         experiment
            ...
            values:
               ...
               -             - attrs[experiment]
               -             - common[experiment]
               -             - internal[CV_experiment][id] formatted with function from self named upper({})
               -       
