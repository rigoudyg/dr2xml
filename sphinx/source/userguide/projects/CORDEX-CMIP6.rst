Parameters available for project CORDEX-CMIP6
=============================================
...
.. glossary::
   ...
   conventions_version
      ...
      values:
         ...
         - 'CF-1.11'
         - laboratory[conventions_version]
   ...
   domain
      ...
      values:
         ...
         - simulation[domain][internal[context]]
   ...
   domain_id
      ...
      values:
         ...
         - simulation[domain_id][internal[context]]
   ...
   driving_experiment
      ...
      Name of the driving experiment.
   ...
   driving_institution_id
      ...
      values:
         ...
         - simulation[driving_institution_id]
   ...
   driving_source_id
      ...
      values:
         ...
         - simulation[driving_source_id]
      
      num type: 'string'
      
   driving_variant_label
      
      Variant label of the driving simulation.
      
      values:
         
         - simulation[driving_variant_label]
   ...
   version_realization
      ...
      Realization of the current simulation.
      
      values:
         
         - simulation[version_realization]
         - 'v1-r1'
      ...
      Variables
         ...
         grid_mapping
            ...
            values:
               ...
               -    Condition:
               -    
               -       value to check: internal[context]
               -       
               -       check to perform: 'eq'
               -       
      ...
      Variables
         ...
         conventions_version
            ...
            values:
               ...
               - attrs[conventions_version]
               - common[convention_versions]
         ...
         driving_experiment_id
            ...
            values:
               ...
               - attrs[driving_experiment_id]
               - common[driving_experiment_id]
         ...
         driving_institution_id
            ...
            values:
               ...
               - attrs[driving_institution_id]
               - common[driving_institution_id]
         ...
         driving_variant_label
            ...
            values:
               ...
               - attrs[driving_variant_label]
               - common[driving_variant_label]
         ...
         Lambert_conformal_longitude_of_central_meridian
            ...
            values:
               ...
               -       values:
               -             
               -             - attrs[Lambert_conformal_longitude_of_central_meridian]
         ...
         Lambert_conformal_standard_parallel
            ...
            values:
               ...
               -       values:
               -             
               -             - attrs[Lambert_conformal_standard_parallel]
               -             - common[Lambert_conformal_standard_parallel]
               -       
         ...
         Lambert_conformal_latitude_of_projection_origin
            ...
            values:
               ...
               -       values:
               -             
               -             - attrs[Lambert_conformal_latitude_of_projection_origin]
               -             - common[Lambert_conformal_latitude_of_projection_origin]
               -       
         ...
         source
            ...
            values:
               ...
               - attrs[source]
               - laboratory[source_description][internal[source_id]]
         ...
         title
            ...
            values:
               ...
               - function from self named format('source'= internal[source_id], 'project'= 'CORDEX-CMIP6', 'driving'= common[driving_experiment], 'expid'= common[expid_in_filename])
