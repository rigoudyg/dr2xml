...
simulation_settings = {
    'comment': '',
    'listof_home_vars': '{path_homedr}/home_data_request_aladin_RCM.SP.txt '
                        '{path_homedr}/home_data_request_aladin_aerosols_RCM.SP.txt '
                        '{path_homedr}/home_data_request_trip_RCM.SP.txt '
