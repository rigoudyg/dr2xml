...
"""
Tests for simulation historical
"""
...
class TestHistoricalCMIP7stdCMIP6(unittest.TestCase, TestSimulation):
    """
    Test output generation for AOESM_historical_CMIP7
    """
    def setUp(self):
        config = create_config_elements(
            simulation="AOESM_historical_CMIP7_stdCMIP6",
            contexts=["nemo", "surfex", "trip"],
            year="1850",
            enddate="18510101",
            pingfiles="{path_xml}/ping_surfex.xml {path_xml}/ping_trip.xml {path_xml}/ping_nemo.xml",
            attributes=[('EXPID', 'CNRM-ESM2-1_historical_r1i1p1f2_v2'),
