...
lab_and_model_settings = {
    ...
    'comments': {
        ...
        'drivw': CTRIP_rwb_comment
    },
    'included_tables': ['Amon'],
    'max_file_size_in_floats': 4. * 1.e+9,
    ...
    'print_variables': ['activity_id', 'description', 'comment', 'contact', 'Conventions', 'creation_date',
                        ...
                        'grid_label', 'history', 'institution', 'institution_id', 'nominal_resolution', 'product',
                        'realization_index', 'realm', 'references', 'source', 'source_id', 'table_id', 'title',
