...
lab_and_model_settings = {
    ...
    'configurations': {
        "ARCM": ("CNRM-ALADIN6", "ARCM AER", ['nemo']),
    ...
    "comment": "CORDEX MED-11 CNRM-ALADIN 6.3 L91. Reference : Daniel M., Lemonsu A., Déqué M., Somot S., Alias A., "
               "Masson V. (2018) Benefits of explicit urban parametrization in regional climate modelling to study "
               "climate and city interactions. Climate Dynamics, 1-20, doi:10.1007/s00382-018-4289-x",
    # "comment": "CORDEX MED-11 CNRM-ALADIN 6.3 L91. Reference : Daniel M., Lemonsu A., Déqué M., Somot S., Alias A., "
               # "Masson V. (2018) Benefits of explicit urban parametrization in regional climate modelling to study "
               # "climate and city interactions. Climate Dynamics, 1-20, doi:10.1007/s00382-018-4289-x",
    ...
    "excluded_vars_per_config": {
        ...
        "AGCM": ["ch4", "co2", "co", "concdust", "ec550aer", "h2o", "hcho", "hcl",
                 ...
                 'emiss', 'od440aer', 'od870aer', 'od550lt1aer', 'wetbc', 'wetdust', 'wetoa', 'wetso4', 'wetss',
                 'cLand',
                 'cSoil', 'fAnthDisturb', 'fDeforestToProduct', 'fFireNat', 'fLuc', 'fProductDecomp',
    ...
    'orphan_variables': {'nemo': [''],
                         'surfex': ['siconca'],
                         'trip': ['areacellr', 'dgw', 'drivw', 'qgwr', 'rivi', 'rivo', 'waterDpth', 'wtd', 'fwtd',
                                  'fldf',
    ...
    'grid_choice': {"CNRM-ALADIN6": "REG", "CNRM-RCSM6": "REG", "CNRM-CM6-1": "LR", "CNRM-CM6-1-HR": "HR",
