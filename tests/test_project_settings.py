...
class TestProjectSettings(unittest.TestCase):
	...
	def test_ping_settings(self):
		...
		ref_init = {
			...
			'vocabulary_config': f'{project_dir}/dr2xml/vocabulary/vocabulary.json',
			'vocabulary_project': "ping",
			'vocabulary_used': None
		}
		self.assertDictEqual(init, ref_init)
		...
		ref_internal = {'CFsubhr_frequency': '1ts',
		                ...
		                'experiment_id': None,
		                'extravar_regions': {'default': 'default'},
		                ...
		                'select_on_inc_and_exc': False,
		                'select_on_year': False,
		                'select_sizes': {'nb_cosp_sites': 129,
		                ...
		                'synchronisation_frequency': None,
		                'tierMax': 3,
		                'tierMax_lset': 3,
		                'too_long_periods': [],
		                'update_grid_label': True,
