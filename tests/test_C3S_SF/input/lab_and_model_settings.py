...
lab_and_model_settings = {
    ...
    'commit': '2021-01-01T00:00:00Z http://www.umr-cnrm.fr/IMG/pdf/system8-technical.pdf',
    'summary': 'Seasonal Forecast data produced by Meteo-France as its contribution to the seasonal forecast activity '
               'of the Copernicus Climate Change Service (C3S). The data has global coverage with a 1-degree horizontal'
               ' resolution and spans for around 6 months since the start date',
    'keywords': ['Seasonal Forecasts', 'C3S', 'ECMWF', 'Copernicus', 'Climate Change', 'Climate Services',
                 'Earth Science Services', 'Environmental Advisories', 'Climate Advisories'],
    'description': '',
    'realms_per_context':
        {
            'nemo': ['seaIce', 'ocean', 'ocean seaIce', 'ocnBgChem', 'seaIce ocean'],
            'surfex': ['atmos', 'atmos atmosChem', 'atmosChem', 'aerosol', 'atmos land', 'land', 'landIce land',
                       'aerosol', 'land landIce', 'landIce'],
            'trip': []
        },
    'fx_from_file':
        {
    ...
    'institution_id': 'lfpw',
    'institution': 'Meteo-France, Toulouse, France',
    'title': 'Meteo-France seasonal forecast model output prepared for C3S',
    ...
    'excluded_vars_per_config':
        {
            'AGCM': ['ch4', 'co2', 'co', 'concdust', 'ec550aer', 'h2o', 'hcho', 'hcl', 'hno3', 'mmrbc', 'mmrdust',
                     'mmroa', 'mmrso4', 'mmrss', 'n2o', 'no2', 'no', 'o3Clim', 'o3loss', 'o3prod', 'oh', 'so2',
                     'mmrpm1', 'fco2antt', 'fco2fos', 'fco2nat', 'loadbc', 'loaddust', 'loadoa', 'loadso4', 'loadss',
                     'oxloss', 'oxprod', 'vmrox', 'bry', 'cly', 'ho2', 'meanage', 'noy', 'drybc', 'drydust', 'dryoa',
                     'dryso2', 'dryso4', 'dryss', 'emibc', 'emidust', 'emioa', 'emiso2', 'emiso4', 'emiss', 'od440aer',
                     'od870aer', 'od550lt1aer', 'wetbc', 'wetdust', 'wetoa', 'wetso4', 'wetss', 'cLand', 'cSoil',
                     'fAnthDisturb', 'fDeforestToProduct', 'fFireNat', 'fLuc', 'fProductDecomp', 'netAtmosLandCO2Flux',
                     'od443dust', 'od865dust', 'sconcdust', 'sconcso4', 'sconcss', 'sedustCI', 'burntFractionAll',
                     'cLitter', 'cProduct', 'cVeg', 'fFire', 'fLitterSoil', 'fVegLitter', 'nbp', 'shrubFrac'],
            'AESM': ['co2mass', 'ch4global', 'n2oglobal'],
            'AOGCM': ['ch4', 'co2', 'co', 'concdust', 'ec550aer', 'h2o', 'hcho', 'hcl', 'hno3', 'mmrbc', 'mmrdust',
                      'mmroa', 'mmrso4', 'mmrss', 'n2o', 'no2', 'no', 'o3Clim', 'o3loss', 'o3prod', 'oh', 'so2',
                      'mmrpm1', 'fco2antt', 'fco2fos', 'fco2nat', 'loadbc', 'loaddust', 'loadoa', 'loadso4', 'loadss',
                      'oxloss', 'oxprod', 'vmrox', 'bry', 'cly', 'ho2', 'meanage', 'noy', 'drybc', 'drydust', 'dryoa',
                      'dryso2', 'dryso4', 'dryss', 'emibc', 'emidust', 'emioa', 'emiso2', 'emiso4', 'emiss', 'od440aer',
