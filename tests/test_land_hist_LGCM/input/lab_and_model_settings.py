...
lab_and_model_settings = {
    ...
    'comments': {
        ...
        'sw': 'Surface floodplains water storage (e.g. Decharme et al. 2019)',
        ...
        'eow': 'Liquid water evaporation from floodplains (e.g. Decharme et al. 2019)',
        ...
        'mrtws': 'ISBA-CTRIP total water storage (soil+canopy+snow+rivers+groundwater+floodplains; e.g. Decharme et al. 2019)',
    ...
    'excluded_vars_per_config': {
        ...
        'LGCM': ['ch4', 'co2', 'hur', 'hus', 'n2o', 'o3', 'ta', 'ua', 'va', 'wap', 'zg', 'clt', 'ccb', 'cct', 'ci',
                 'clivi', 'clt', 'clwvi', 'fco2antt', 'fco2fos', 'prc', 'prw', 'ps', 'psl', 'rldscs', 'rlut', 'rlutcs',
                 'rsdscs', 'rsdt', 'rsuscs', 'rsut', 'rsutcs', 'ch4global', 'co2mass', 'n2oglobal', 'mc', 'cl', 'cli',
                 'clw'], 'AOESM': ['co2mass', 'ch4global', 'n2oglobal'],
